            ...
            <div class="content" :style="'overflow: auto; height:' + props.maxHeight + 'px'">
                ...
                <div class="item top bottom">
                    ...
                    <div class="lists">
                        ...
                        <div class="list">授权使用：{{school}}</div>
...
export default {
  data() {
    return {
      school: localStorage.jxschool_name,
      img1: "../static/imgs/wechat.jpg",
      title: "首页",
      // 初始化空对象
      chart: null,
      // 性别
      ...
      this.$http
        ...
        .then(res => {
          ...
          this.drawGraph(
            "teacherChart",
            this.opinionTeacher,
            this.opinionDataTeacher,
            "学校教师学历统计"
          );
          this.drawGraph(
            "nationChart",
            this.opinionNation,
            this.opinionDataNation,
            "校内学生民族统计"
          );

          this.drawLine(
            "studentsChart",
            this.opinionStudents,
            this.opinionStudentsData,
            "学生人数年级分布",
            "年级",
            "人数"
          );
