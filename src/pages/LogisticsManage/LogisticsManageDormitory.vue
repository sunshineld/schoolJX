<template>
    <div>
        ...
        title="宿舍管理">
            <template slot="head">
                    <el-input v-model="search" :maxlength='20' size="smail" placeholder="请输入宿舍号" style="width:200px;"></el-input>
                    ...
                    <template slot="content">
                        <el-form >
                            ...
                            <el-form-item label="楼栋：" :label-width="formLabelWidth" >
                                <el-input v-model="form.building_no" :maxlength='20' auto-complete="off" placeholder="请输入楼栋"  :clearable="true"></el-input>
                            </el-form-item>
                            <el-form-item label="楼层：" :label-width="formLabelWidth" >
                                <el-input v-model="form.floor" :maxlength='2' auto-complete="off" placeholder="请输入楼层"  :clearable="true"></el-input>
                            </el-form-item>
                            <el-form-item label="宿舍号：" :label-width="formLabelWidth" >
                                <el-input v-model="form.dormitory_no" :maxlength='20' auto-complete="off" placeholder="请输入宿舍号"  :clearable="true"></el-input>
                            </el-form-item>
                            <el-form-item label="可住人数：" :label-width="formLabelWidth" >
                                <el-input v-model="form.exp_people" :maxlength='2' auto-complete="off" placeholder="请输入可住人数"  :clearable="true"></el-input>
                            </el-form-item>
                        </el-form>
                    </template>
                    <template slot="foot">
...
export default {
  ...
  methods: {
    ...
    addConfirm() {
      ...
      if (
        this.form.building_no.trim() == "" ||
        this.form.building_no.toString().trim() == ""
      ) {
        this.$message.error("请输入楼栋编号!");
        return;
      }
      if (
        this.form.floor.trim() == "" ||
        this.form.floor.toString().trim() == ""
      ) {
        this.$message.error("请输入楼层数字!");
        return;
      }
      if (
        this.form.exp_people.trim() == "" ||
        this.form.exp_people.toString().trim() == ""
      ) {
      ...
      //提交
      this.$http
        .post("/SchoolDormitory/add", this.form)
        .then(res => {
          this.$message.success("操作成功!");
    ...
    editfn() {
      ...
      //提交
      this.$http
        .post("/SchoolDormitory/edit", this.form)
        .then(res => {
          this.$message.success("操作成功!");
          this.dialogFormVisibleAdd = false;
          this.req();
