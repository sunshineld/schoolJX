	                   ...
	                   <template slot="content">
	                   		<el-form >
	                            <el-form-item label="规则名称:" :label-width="formLabelWidth">
	                                <el-input v-model="form.name" :maxlength="20" auto-complete="off" placeholder="请输入规则名称"  :clearable="true"></el-input>
	                            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    editShow(val) {
      ...
      this.form.am_start = val.am_start;
      this.form.am_end = val.am_end;
      this.form.pm_start = val.pm_start;
      this.form.pm_end = val.pm_end;
    ...
    addfn() {
      ...
      if (!rule.test(this.form.name)) {
        this.$message.error("请输入汉字、数字或字母且长度不超过20个字符!");
        return;
      }
