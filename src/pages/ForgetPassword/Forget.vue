<template>
  <div class="login">
    ...
    <div class="content">
        <div class="lists">
            <el-input placeholder="请输入您的手机号码" v-model="submitForm.phone" 
            ...
            <el-input placeholder="请确认新密码" type="password" v-model="submitForm.repassword" @keyup.enter.native="btnClickForNextStep">
            </el-input>
        </div>
...
export default {
  ...
  methods: {
    btnClickForNextStep() {
      ...
      if (
        this.submitForm.password.trim() == "" ||
        this.submitForm.password.toString().trim() == ""
      ) {
        this.$message.error("请输入新密码!");
        return;
      }
      if (
        this.submitForm.repassword.trim() == "" ||
        this.submitForm.repassword.toString().trim() == ""
      ) {
