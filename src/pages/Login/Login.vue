  ...
  <div class="login">
    ...
    <div class="content">
        ...
        <div class="lists">
            ...
            <el-input placeholder="手机号码" v-model="phone" :maxlength="maxlength" tabindex="1" :auto-complete="ison">
              <template slot="prepend">
                <img src="../../../static/imgs/phone.png" alt="">
              </template>
            </el-input>
            <el-input placeholder="密码" v-model="password" type="password" tabindex="2" :auto-complete="ison">
              <template slot="prepend">
                <img src="../../../static/imgs/password.png" alt="">
              </template>
            </el-input>
            <div class="codecover">
              <input type="text" v-model="img_code" placeholder="请输入验证码" class="codeinput" @keyup.enter="btnClickForNextStep" tabindex="3">
              <img @click="changeVerifyCodeUrl" :src="verifyCodeBaseUrl" alt="" style="width:50%;">
            </div>
        </div>
        <el-button type="primary" class="submit" :loading="false" @click="btnClickForNextStep" tabindex="4">登录</el-button>
