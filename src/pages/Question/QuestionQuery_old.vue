...
//                 <li @click="choosed('structure',item.id,item.id,$event, version_index === item.id)" 
//                 :class="setLiCSS('structureLi', structure_index === item.id)" 
//                 v-for="(item,index) in structureList" 
//                 :key="index">{{item.name}}</li>
//                 <!-- <li 
//                 :class="setLiCSS('structureLi', structure_index === index)"
//                 :key="index"
//                 @click="choosed('structure',item.id,index,$event, version_index === index)"
//                 v-for="(item, index) in structureList">{{item.name}}</li> -->
//             </ul>
...
//         </template>
//         <template
//         v-else-if="structure_id === 2"></template>
...
//                     structure_type: this.structure_index
//                 })
//                 .then(res=>{
//                     // console.log(res);
...
//         change () {
//             this.$emit('change', {
//                 structure_type: this.structure_id,
//                 versions_id:this.versions_id,
