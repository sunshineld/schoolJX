    ...
    class="questionstable">
        <template slot="head">
            <div class="choose">
                    ...
                    <div class="choose_sub" v-if="chapter_isShow">
                    ...
                    <div class="choose_sub node" v-if="node_isShow">
                        ...
                        <span class="choose_more node_more" 
...
export default {
  ...
  methods: {
    ...
    choosed(name, val, index, e, isSelect) {
      ...
      if (name == "chapter") {
        this.page_number = 1;
        document.getElementsByClassName("node")[0].style.height = "36px";
        document.getElementsByClassName("type")[0].style.height = "36px";
        document.getElementsByClassName("node_more")[0].innerHTML =
    ...
    confirm: function() {
      ...
      this.$http
        ...
        .then(res => {
          ...
          this.$router.push(
            "/papers-create?type=" + type + "&papers_type=" + papers_type
          );
        })
        .catch(res => {
          this.$message.error(res.info);
