<template>
    <div>
        ...
        title="资产列表">
            <template slot="head">
                <el-select clearable v-model="type" placeholder="请选择资产类型" >
                    <el-option
                ...
                <el-input v-model="number" :maxlength="maxlength20" size="smail" placeholder="请输入资产编号" :clearable="true" style="width:200px;"></el-input>
                    ...
                    <template slot="content">
                        <el-form :label-width="formLabelWidth">
                            <el-form-item label="资产名称:"  >
                                <el-input v-model="form.name" :maxlength="maxlength20" auto-complete="off" placeholder="请输入资产名称" ></el-input>
                            </el-form-item>
                            <el-form-item label="资产编号:"  :label-width="formLabelWidth">
                                <el-input v-model="form.number" :maxlength="maxlength20" auto-complete="off" placeholder="请输入资产编号" ></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="资产单价" :label-width="formLabelWidth">
                                <el-input v-model="form.price" :maxlength="maxlength8" auto-complete="off" placeholder="请输入资产单价" :clearable="true"></el-input>
                            </el-form-item>
                            <el-form-item label="资产数量" :label-width="formLabelWidth">
                                <el-input v-model="form.num" :maxlength="maxlength5" auto-complete="off" placeholder="请输入资产数量" :clearable="true"></el-input>
                            </el-form-item>
                            <el-form-item label="负责人" :label-width="formLabelWidth">
                                <el-input v-model="form.manager" :maxlength="maxlength20" auto-complete="off" placeholder="请输入负责人名称" :clearable="true"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="存放地点"  :label-width="formLabelWidth">
                                <el-input v-model="form.place" :maxlength="maxlength50" auto-complete="off" placeholder="请输入存放地点" :clearable="true"></el-input>
                            </el-form-item>
                        </el-form>
                    </template>
                    <template slot="foot">
  ...
  methods: {
    ...
    handleClick: function(val) {
      this.$http
        ...
        .then(res => {
          console.log(res);
          res.data.input_time = this.$tools.formatDate(res.data.input_time.toString(),
            "yyyy-MM-dd");
          this.form = res.data;
    ...
    addfn() {
      ...
      if (
        ...
        this.form.number.toString().trim() == ""
      ) {
      ...
      // }
      if (
        this.form.manager.trim() == "" ||
        this.form.manager.toString().trim() == ""
      ) {
      ...
      if (
        this.form.place.trim() == "" ||
        this.form.place.toString().trim() == ""
      ) {
      ...
      this.form.input_time = this.$tools.stringToDate(
        this.form.input_time.toString()
      );
      //提交
      this.$http
        .post("/fund/create", this.form)
        .then(res => {
          this.$message.success("操作成功!");
